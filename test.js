function str_pad(byte){
    ...
    exports.handle = function(event, context) {
        ...
        try {
            ...
            return {
                body: JSON.stringify({
                    "error": "No JSON sent, please sent as '{\"bytes\": []}'.",
                    "payload" : payload,
                }),
                statusCode: 400,
            }
        ...
        if (payload.bytes === undefined) {
            return {
                body: JSON.stringify({
                    "error": "No bytes attached in request data.",
                    "payload" : payload,
                }),
                statusCode: 400,
            }
        ...
        if (bytes.length !== 11) {
            return {
                body: JSON.stringify({
                    "error": "Payload has to be 11 bytes of data.",
                    "bytes" : bytes,
                }),
                statusCode: 400,
            }
...
console.log(exports.handle({
"body": {
    "bytes" : [203, 244, 255, 140, 3, 232, 5, 0, 0, 127, 255]
}
}))